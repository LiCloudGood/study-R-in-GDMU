...
> `资料/答案/第七周答案` 中没有收录 `test0709.R`，此处仅给出思路提示，不算作参考答案。
:::
...
> `资料/答案/第七周答案` 中没有收录 `test0710.R`，此处仅给出思路提示，不算作参考答案。
:::
...
::: info 关于本页的题目与答案
题目来自 `资料/原题/第七周原题`，答案来自 `资料/答案/第七周答案`（仅修正过其中的错别字）。
`资料/答案/第七周答案` 收录了实验一~八的脚本；实验九、十为课后思考题，暂无答案脚本。
:::
