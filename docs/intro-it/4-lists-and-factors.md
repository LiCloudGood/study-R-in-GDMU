...
::: info 关于本页的题目与答案
题目来自 `资料/原题/第四周原题`，答案来自 `资料/答案/第四周答案`。
:::

::: tip 想弄懂背后的统计学原理
这一讲讲**因子与列联表在 R 里怎么建**；率、构成比、相对比的区别与率的标准化，见《卫生统计学》对应的归纳。

详见 **[《卫生统计学》第 5 章　定性资料的统计描述](/Health-statistics/05-describing-qualitative-data)**。
:::
