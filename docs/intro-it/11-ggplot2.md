...
::: tip 答案里的图是跑好的
ggplot2 画出来的图就在下面的参考答案里，同样是事先跑好的静态图片。
自己在 RStudio 里跑第一遍时要注意：`ggplot2` 是个很大的包，加载可能要等上一会儿。
:::
...
<div class="q-figures">
  <figure>
    <img :src="withBase('/figures/11-question/fig01.png')" alt="图 1" loading="lazy" />
    <figcaption>图 1</figcaption>
  </figure>
  <figure>
    <img :src="withBase('/figures/11-question/fig02.png')" alt="图 2" loading="lazy" />
...
<div class="q-figures">
  <figure>
    <img :src="withBase('/figures/11-question/fig03.png')" alt="图 3" loading="lazy" />
...
<div class="q-figures">
  <figure>
    <img :src="withBase('/figures/11-question/fig04.png')" alt="图 4" loading="lazy" />
...
<div class="q-figures">
  <figure>
    <img :src="withBase('/figures/11-question/fig05.png')" alt="图 5" loading="lazy" />
...
<div class="q-figures">
  <figure>
    <img :src="withBase('/figures/11-question/fig06.png')" alt="图 6" loading="lazy" />
...
<div class="q-figures">
  <figure>
    <img :src="withBase('/figures/11-question/fig07.png')" alt="图 7" loading="lazy" />
